...
#if __has_include(<KFileMetaData/KFM_TypeInfo.h>)
#include <KFileMetaData/KFM_TypeInfo.h>
#elif __has_include(<KFM_TypeInfo.h>)
#include <KFM_TypeInfo.h>
#else
#error "KFileMetaData KFM_TypeInfo.h not found"
#endif
